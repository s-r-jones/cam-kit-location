...
float4 RY_GY_BY_Y=float4(decodeSample(param_24),decodeSample(param_25));
...
float3 R_G_B=tex_R_G_BSample.xyz;
...
float3 RR_GG_BB=tex_RR_GG_BBSample.xyz;
...
float3 RG_RB_GB=tex_RG_RB_GBSample.xyz;
