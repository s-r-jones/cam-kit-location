...
vec4 l9_5=log((vec4(0.29899999,0.58700001,0.114,0.0)*l9_4)/vec4(dot(l9_0,vec4(0.29899999,0.58700001,0.114,0.0))+1e-06));
vec4 l9_6=exp((l9_5*l9_5)*((-1.0)/((2.0*softSkinRadius)*softSkinRadius)))*0.36787945;
float l9_7=1.0+dot(l9_6,vec4(1.0));
vec4 l9_8=l9_0+(l9_4*l9_6);
vec4 l9_9;
#if (ADD_NOISE)
{
float l9_10=(fract(sin(dot(varPackedTex.xy,vec2(12.9898,78.233002)))*43758.547)-0.5)/30.0;
